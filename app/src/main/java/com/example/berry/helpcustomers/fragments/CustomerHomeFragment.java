 ...
 *
 */
public class CustomerHomeFragment extends Fragment implements OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_customer_home, container, false);
        ImageButton speakButton = myView.findViewById(R.id.buttonListen);
    ...
    public void logthis (String newinfo) {
        if (newinfo != "") {
            editTextSearch.setText(editTextSearch.getText() + "\n" + newinfo);
            search();
    ...
    private void search() {
        ...
        if (query.isEmpty()){
            editTextSearch.setError("Please enter a keyword");
